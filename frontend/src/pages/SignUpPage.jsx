...
const SignUpPage = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
      ...
      >
        <h2 className='mt-10 text-center text-3xl font-extrabold text-gray-900'>Create your account</h2>
      ...
      >
        ...
        <div className='bg-gray-100 py-8 px-4 shadow sm:px-10'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              <label htmlFor="confirmPassword" className='block text-sm font-medium text-gray-700'>Comfirm Password</label>
              <div className='mt-1 relative shadow-sm'>
                <div className='absolute inset-y-0 left-2 flex items-center pointer-events-none'>
                  <Lock className='h-5 w-5 text-gray-400' aria-hidden='true' />
                </div>
            ...
            <p className='mt-8 text-center text-sm text-gray-400'>
              ...
              <Link to='/login' className='font-semibold text-gray-800 hover:text-gray-600 ml-1'>
                Login here 
