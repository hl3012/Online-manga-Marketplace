...
const PurchaseSuccessPage = () => {
  ...
  return (
    <div className='h-screen flex items-center justify-center px-4'>
        ...
        <div className='max-w-md w-full bg-gray-900 shadow-xl overflow-hidden relative z-10'>
            <div className='p-6 sm:p-8'>
                ...
                <p className='text-gray-300 text-center mb-2'>
                    Thank you. {"We're"} processing it now.
                </p>
                ...
                <div className='space-y-4'>
                    <button
                        className='w-full bg-white hover:bg-gray-300 text-black font-bold py-2 px-4
