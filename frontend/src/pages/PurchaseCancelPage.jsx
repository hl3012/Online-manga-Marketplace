	...
	return (
		<div className='min-h-screen flex items-center justify-center px-4'>
			<motion.div
				...
				className='max-w-md w-full bg-gray-900  shadow-xl overflow-hidden relative z-10'
			>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<Link
							to={"/"}
							className='w-full bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 transition duration-300 flex items-center justify-center'
						>
