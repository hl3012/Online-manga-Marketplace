        ...
        <div className='space-y-4'>
            <div>
                ...
                <input 
                    type='text'
                    id='voucher'
                    className='block w-full border border-gray-600 bg-gray-700
            ...
            <motion.button
                type='button'
                className='flex w-full items-center justify-center bg-white px-5 py-2.5 text-sm text-gray-900
                            font-medium hover:bg-gray-200 focus:outline-none focus:ring-4
